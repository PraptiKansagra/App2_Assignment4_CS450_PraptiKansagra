...
class Child2 extends Component {
    ...
    componentDidUpdate() {
        ...
        var container = d3.select(".child2_svg").attr("width", w + margin.left + margin.right).attr("height", h + margin.top + margin.bottom).select(".g_2").attr("transform", 'translate(${margin.left}, ${margin.top})');
        ...
        container.selectAll("circle").data(data).join("circle").attr("cy", function (d) {
